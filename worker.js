...
app.get('/login', (req,res) => {
    ...
    logger.warn(`Login usuario ${req.user.displayName}`)
        res.render("home", {
...
app.get('/faillogin', (req,res) => {
    logger.error(`Error en Login usuario `)
    res.render('login-error', {});
})

app.get('/logout', (req,res) => {
    logger.warn(`Logout usuario ${req.user.displayName}`)
